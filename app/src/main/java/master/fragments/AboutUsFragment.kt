...
class AboutUsFragment : BaseFragment(), View.OnClickListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initToolbar()
        tvVersion?.text = getString(R.string.version).plus(": " + BuildConfig.VERSION_NAME)
        initOnclickListner()
    }
    ...
    private fun callIntent() {
        val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + getString(R.string.company_phone)))
    ...
    private fun webIntent() {
        val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("www.20master.com"))
